...
export const useCurrentUser = () => {
  return useQuery(GET_CURRENT_USER_QUERY, {pollInterval: 1000});
};

// export const getAllCategories = () => {
//   return useQuery(GET_ALL_CATEGORIES_MUTATION);
// };
...
export const useProducts = (ids, value) => {
  ...
  return useQuery(GET_PRODUCTS_QUERY, {variables: {ids, value}});
};
...
export const useCartItem = id => {
  return useQuery(GET_CART_ITEM_QUERY, {variables: {id}, pollInterval: 700});
};
